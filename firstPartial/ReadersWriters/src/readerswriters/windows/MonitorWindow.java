...
public class MonitorWindow extends javax.swing.JFrame {
    ...
    // tableModel initialized as attribute — never null (learned from previous project)
    ...
    // == Setup renderers and column widths — called after initComponents ==
    private void setupTable() {
        MonitoringTable.setModel(tableModel);
        MonitoringTable.setRowHeight(28); // Taller rows so colors are visible

        // ── Color column renderer — paints cell with writer's color ──
        MonitoringTable.getColumnModel().getColumn(COL_COLOR).setCellRenderer(
            ...
            public Component getTableCellRendererComponent(
                ...
                if (value instanceof Color) {
                    setBackground((Color) value); // Paint with writer color
                    setText("");
                } else {
                    setBackground(Color.LIGHT_GRAY); // Reader has no color
                    setText("—");
                }
                return this;
            }
        ...
        MonitoringTable.getColumnModel().getColumn(COL_STATE).setCellRenderer(
                new DefaultTableCellRenderer() {
            @Override
            public Component getTableCellRendererComponent(
                    javax.swing.JTable t, Object value, boolean selected,
        ...
        // Column widths
        MonitoringTable.getColumnModel().getColumn(COL_NAME).setPreferredWidth(80);
        MonitoringTable.getColumnModel().getColumn(COL_TYPE).setPreferredWidth(90);
        MonitoringTable.getColumnModel().getColumn(COL_COLOR).setPreferredWidth(60);
        MonitoringTable.getColumnModel().getColumn(COL_STATE).setPreferredWidth(100);
        MonitoringTable.getColumnModel().getColumn(COL_COUNT).setPreferredWidth(90);
    }
    ...
    public void addProcess(String name, String type, Color color) {
        javax.swing.SwingUtilities.invokeLater(()
            ...
            color, // Writer color, null for reader
    ...
    // == Called when read or write happens — increments counter ==
    ...
    private void initComponents() {
        ...
        MonitoringTable = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        MonitoringTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(MonitoringTable);
    ...
    private javax.swing.JTable MonitoringTable;
